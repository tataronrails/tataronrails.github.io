...
$(function() {
    $('.overlay-menu ul li a,.scroll-top a,a.banner-button,.page-scroll').bind('click', function(event) {
        var $anchor = $(this);
    ...
    $('.popup-gallery').magnificPopup({
        ...
        image: {
            ...
            titleSrc: function(item) {
                return item.el.attr('title') + '<small>by Tatar on Rails</small>';
            }
        },
        callbacks: {
          close: function() {
...
window.$zopim||(function(d,s){var z=$zopim=function(c){
    ...
    $.src='//v2.zopim.com/?3lRhJvJlZxnbdd9FM1UumjPqa4WIMvS8';z.t=+new Date;$.
